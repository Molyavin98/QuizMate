...
public final class WordDao_Impl implements WordDao {
  ...
  @Override
  public Object deleteWord(final WordEntity word, final Continuation<? super Unit> $completion) {
  ...
  @Override
  public Flow<List<WordEntity>> getAllWords() {
      ...
      public List<WordEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new WordEntity(_tmpId,_tmpEnglish,_tmpUkrainian,_tmpExample,_tmpCategory,_tmpDifficulty,_tmpImageUrl,_tmpFolderId,_tmpCreatedAt,_tmpLastPracticed,_tmpCorrectCount,_tmpIncorrectCount,_tmpIsFavorite,_tmpIsLearned,_tmpPracticeCount,_tmpFirestoreId);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  @Override
  public Object getAllWordsSync(final Continuation<? super List<WordEntity>> $completion) {
    final String _sql = "SELECT * FROM words ORDER BY createdAt DESC";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
  ...
  @Override
  public Object getWordById(final long id, final Continuation<? super WordEntity> $completion) {
      ...
      public WordEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _result = new WordEntity(_tmpId,_tmpEnglish,_tmpUkrainian,_tmpExample,_tmpCategory,_tmpDifficulty,_tmpImageUrl,_tmpFolderId,_tmpCreatedAt,_tmpLastPracticed,_tmpCorrectCount,_tmpIncorrectCount,_tmpIsFavorite,_tmpIsLearned,_tmpPracticeCount,_tmpFirestoreId);
          } else {
            _result = null;
          }
          return _result;
  ...
  @Override
  public Flow<List<WordEntity>> searchWords(final String query) {
    final String _sql = "\n"
            + "        SELECT * FROM words\n"
            + "        WHERE english LIKE '%' || ? || '%'\n"
            + "        OR ukrainian LIKE '%' || ? || '%'\n"
  ...
  @Override
  public Flow<List<WordEntity>> getWordsByCategory(final String category) {
  ...
  @Override
  public Flow<List<WordEntity>> getWordsByFolder(final long folderId) {
  ...
  @Override
  public Flow<List<WordEntity>> getWordsWithoutFolder() {
  ...
  @Override
  public Flow<List<WordEntity>> getFavoriteWords() {
