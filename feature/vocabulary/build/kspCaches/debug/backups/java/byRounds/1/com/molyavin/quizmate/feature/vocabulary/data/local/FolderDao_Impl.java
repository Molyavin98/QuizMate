...
public final class FolderDao_Impl implements FolderDao {
  ...
  @Override
  public Flow<List<FolderWithWordCountEntity>> getAllFoldersWithWordCount() {
    final String _sql = "\n"
            + "        SELECT f.*,\n"
    ...
    return CoroutinesRoom.createFlow(__db, true, new String[] {"words",
        "folders"}, new Callable<List<FolderWithWordCountEntity>>() {
      @Override
      @NonNull
      public List<FolderWithWordCountEntity> call() throws Exception {
        __db.beginTransaction();
        try {
          ...
          try {
            ...
            final List<FolderWithWordCountEntity> _result = new ArrayList<FolderWithWordCountEntity>(_cursor.getCount());
            while (_cursor.moveToNext()) {
              final FolderWithWordCountEntity _item;
              final long _tmpId;
              ...
              _item = new FolderWithWordCountEntity(_tmpId,_tmpName,_tmpCreatedAt,_tmpFirestoreId,_tmpWordCount);
              _result.add(_item);
            }
            __db.setTransactionSuccessful();
            return _result;
      ...
      public List<FolderEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new FolderEntity(_tmpId,_tmpName,_tmpCreatedAt,_tmpFirestoreId);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  @Override
  public Object getAllFoldersSync(final Continuation<? super List<FolderEntity>> $completion) {
    final String _sql = "SELECT * FROM folders ORDER BY createdAt DESC";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
      ...
      public FolderEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _result = new FolderEntity(_tmpId,_tmpName,_tmpCreatedAt,_tmpFirestoreId);
          } else {
            _result = null;
          }
          return _result;
