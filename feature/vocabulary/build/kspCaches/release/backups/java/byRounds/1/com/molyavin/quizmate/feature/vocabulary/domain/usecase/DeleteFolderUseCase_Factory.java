...
public final class DeleteFolderUseCase_Factory implements Factory<DeleteFolderUseCase> {
  ...
  public DeleteFolderUseCase_Factory(Provider<VocabularyRepository> repositoryProvider) {
  ...
  public static DeleteFolderUseCase_Factory create(
      Provider<VocabularyRepository> repositoryProvider) {
    return new DeleteFolderUseCase_Factory(repositoryProvider);
  }

  public static DeleteFolderUseCase newInstance(VocabularyRepository repository) {
