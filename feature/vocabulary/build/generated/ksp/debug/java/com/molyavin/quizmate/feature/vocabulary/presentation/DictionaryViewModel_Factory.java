...
public final class DictionaryViewModel_Factory implements Factory<DictionaryViewModel> {
  ...
  public DictionaryViewModel_Factory(Provider<GetAllWordsUseCase> getAllWordsUseCaseProvider,
      ...
      Provider<VocabularyWordDao> wordDaoProvider,
  ...
  public static DictionaryViewModel newInstance(GetAllWordsUseCase getAllWordsUseCase,
                                                ...
                                                GetWordsByFolderUseCase getWordsByFolderUseCase, VocabularyWordDao vocabularyWordDao,
                                                VocabularyRepositoryImpl vocabularyRepository) {
    return new DictionaryViewModel(getAllWordsUseCase, addWordUseCase, deleteWordUseCase, searchWordsUseCase, importWordsFromJsonUseCase, deleteAllWordsUseCase, getAllFoldersUseCase, createFolderUseCase, deleteFolderUseCase, getWordsByFolderUseCase, vocabularyWordDao, vocabularyRepository);
  }
}
