...
import com.molyavin.quizmate.feature.vocabulary.data.local.VocabularyFolderDao_Impl;
import com.molyavin.quizmate.feature.vocabulary.data.local.VocabularyWordDao;
import com.molyavin.quizmate.feature.vocabulary.data.local.VocabularyWordDao_Impl;
...
public final class VocabularyDatabase_Impl extends VocabularyDatabase {
  private volatile VocabularyWordDao _Vocabulary_wordDao;

  private volatile VocabularyFolderDao _Vocabulary_folderDao;
  ...
  protected Map<Class<?>, List<Class<?>>> getRequiredTypeConverters() {
    ...
    _typeConvertersMap.put(VocabularyWordDao.class, VocabularyWordDao_Impl.getRequiredConverters());
    _typeConvertersMap.put(VocabularyFolderDao.class, VocabularyFolderDao_Impl.getRequiredConverters());
  ...
  @Override
  public VocabularyWordDao wordDao() {
    if (_Vocabulary_wordDao != null) {
      return _Vocabulary_wordDao;
    } else {
      synchronized(this) {
        if(_Vocabulary_wordDao == null) {
          _Vocabulary_wordDao = new VocabularyWordDao_Impl(this);
        }
        return _Vocabulary_wordDao;
      }
    }
  ...
  @Override
  public VocabularyFolderDao folderDao() {
    if (_Vocabulary_folderDao != null) {
      return _Vocabulary_folderDao;
    } else {
      synchronized(this) {
        if(_Vocabulary_folderDao == null) {
          _Vocabulary_folderDao = new VocabularyFolderDao_Impl(this);
        }
        return _Vocabulary_folderDao;
      }
    }
